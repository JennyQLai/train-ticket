    ...
    <div id="book">
        <table>
            ...
            <tr>
                ...
                <td><a style="color: #666666" href="manager/orderServlet?action=delete2&id=<%=order.getOrder_id()%>&train_id=<%=order.getTrain_id().toString()%>" onclick="javascript:return cancel()">取消订单</a></td>
            </tr>
